...
| ------------ | ----------------------------------------------- | ----------------------- | ------------------------------------------------------------------ |
| TC-01        | Test if the program input for "high" priority   | enter, 'test', 'high'   | 'This task is high priority and should be done first'              |
| TC-02        | Test if the program input for "medium" priority | enter, 'test', 'medium' | 'This task should be scheduled soon'                               |
